...
os.system(
    'python ./examples/pytorch/gcn/train_test.py --dataset=cora --n-epochs=200 --deg-threshold=20')
...
time_start = time.perf_counter()
os.system(
    'python ./examples/pytorch/gcn/train_test.py --dataset=citeseer --n-epochs=200 --deg-threshold=20'
)
...
time_start = time.perf_counter()
os.system(
    'python ./examples/pytorch/gcn/train_test.py --dataset=pubmed --n-epochs=200 --deg-threshold=5')
