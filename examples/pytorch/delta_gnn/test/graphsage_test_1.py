...
def train(args, device, g, dataset, model):
    ...
    sampler = NeighborSampler(
        [-1, -1, -1],  # fanout for [layer-0, layer-1, layer-2]
...
if __name__ == "__main__":
    ...
    # dataset = AsNodePredDataset(CoraGraphDataset(raw_dir='../../../../dataset',
    #                                              transform=transform))
    # dataset = AsNodePredDataset(CiteseerGraphDataset(raw_dir='../../../../dataset', transform=transform))
    g = dataset[0]
