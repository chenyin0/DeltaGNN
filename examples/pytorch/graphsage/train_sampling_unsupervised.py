...
from load_graph import load_reddit, load_ogb, load_cora
...
def run(proc_id, n_gpus, args, devices, data):
    ...
    if n_gpus > 1:
        dist_init_method = 'tcp://{master_ip}:{master_port}'.format(master_ip='127.0.0.1',
                                                                    master_port='12345')
        world_size = n_gpus
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--neg-share',
                           default=False,
                           action='store_true',
